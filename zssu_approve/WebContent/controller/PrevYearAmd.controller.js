sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.PrevYearAmd", {
		onInit: function () {			
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("PYA").attachPatternMatched(this._onObjectMatched, this);
		}, 
		...
		_onObjectMatched: function (oEvent) {
			...
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/PrvYrAmndt.json');
