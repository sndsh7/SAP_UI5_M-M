sap.ui.define([
	...
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.SPD", {

		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("SPD").attachPatternMatched(this._onObjectMatched, this);
		},
		//--------- Local Methods Start -------------------------
		_onObjectMatched: function (oEvent) {
			var oController = this;
			var oModel = new sap.ui.model.json.JSONModel();
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/spdData.json');
...
//			oDataNewPinfoModel.read("/ES_NPIHeader('" + vPnifoNumber + "')", {
			...
			var oActionItem = new sap.m.HBox({
				...
				items: [
					...
					new sap.m.Button({
						...
						press: function (oEvent) {
							var oItemFrag = xmlFragment(oController, "ItemSPD");
		...
		formatterTableVisibleTool:function(vValue){
			return vValue == 0 ? true : false;
