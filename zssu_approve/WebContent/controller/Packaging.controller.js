sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.Packaging", {
		onInit: function () {
...
//			oRouter.attachRoutePatternMatched(this._onObjectMatched, this);
			oRouter.getRoute("PKG").attachPatternMatched(this._onObjectMatched, this);
		}, 
		
		//--------- Local Methods Start -------------------------
		_onObjectMatched: function (oParameter) {
			var oController = this;
			var vPaperNo = oParameter.getParameter("arguments").Number;
			var vPaperCode = oParameter.getParameter("arguments").PaperCode;
			var oModel = new sap.ui.model.json.JSONModel();
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/Packaging.json');
...
//		},
		visiblePartEdit: function(vEditable, vSector, vModel) {
			if (vEditable && vSector && vSector.length > 0 && vModel) {
				return true;
			} else {
				return false;
			}
