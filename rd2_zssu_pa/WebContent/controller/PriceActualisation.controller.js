sap.ui.define(["sap/ui/core/mvc/Controller",
  ...
  var s2;
  var prevAssoName;
  return Controller.extend("com.mahindra.ZSSU_PriceActulistn.controller.PriceActualisation", {
    onInit: function () {
      // Fiori Usage
      var device = "Other";
      var os = jQuery.os.os;
      ...
      var appName  = "ZSSU_PriceActulistn";
      ...
      oDataModel.read("/FioriUsageSet(Appname='ZSSU_PriceActulistn',Device='" + device +
...
//      oController._onObjectMatched(["new","PA"]);
    }, 
    ...
    _onObjectMatched: function (oParameter) {
      ...
      var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_PriceActulistn', '/json/PriceActlsn.json');
      ...
      if (vPaperNo == "new") {
        ...
        var oData = getHeaderObjectPA();
        oData.Nav_Currency.push(getCurrencyStr());
        oData.PaperCode= vPaperCode;
        oData.Createdby = vCurrentUser; // Added by AGAWSA-CONT SF1K92101
...
//      Start ADD by AGAWSA-CONT for delegate to associate
    ...
    _fnAfterGettingBEData: function (oData) {
      ...
      com.mahindra.ZSSU_PriceActulistn.oData = oData;	// Added by AGAWSA-CONT SF1K92101
      var vCurrentUser = sap.ushell.Container.getService("UserInfo").getId(); // Added by AGAWSA-CONT SF1K92101
...
//    Add start By AGWASA-CONT on 05-06-2023
...
//                oModelSSUDigitization.setProperty("/EditableFlag", false);
        ...
        this.getView().byId("id_upc4").setEnableDelete(false);
        this.getView().byId("id_upc5").setEnableDelete(false);
...
//    Add end By AGWASA-CONT on 05-06-2023

//  Comment By AGWASA-CONT on 05-06-2023
//      if (oData.Status === "S" || oData.Status === "R")
//        oModelSSUDigitization.setProperty("/DisplayOnlyFlag", false);
//      else if(oData.Status === "IC")
//        oModelSSUDigitization.setProperty("/PostToSAP", true);
...
//                Add End by AGAWAS-CONT on 05-06-2023
              var oItemFrag = xmlFragment(oController, "ItemActlstn");
...
//
//          var oItemData = getItemDetailsObjectPA();
...
//        }
    ...
    _validationMass: function (Nav_Items) {
      var oController = this;
      var oModelSSUDigitization = oController.getView().getModel("ModelSSUDigitization");
      var oPaperDataSet = oModelSSUDigitization.getProperty("/PaperDataSet");
      var oValidation = {
        "PaperCode": oPaperDataSet.PaperCode,
        "Sector": oPaperDataSet.Sector.toString(),
        "Sign": oPaperDataSet.Sign,
...
//          var vTitle = "Information";
          var vIndexItem;
          /*oPaperDataSet.Cycle =  oData.Cycle;
          oPaperDataSet.Initiator = oData.Initiator
          oPaperDataSet.Approver1 = oData.Approver1
          oPaperDataSet.Approver2 = oData.Approver2
          oPaperDataSet.Approver3 = oData.Approver3
          oPaperDataSet.Approver4 = oData.Approver4  
          oPaperDataSet.Approver5 = oData.Approver5
          oPaperDataSet.Approver6 = oData.Approver6
          oPaperDataSet.Approver7 = oData.Approver7
          oPaperDataSet.Approver8 = oData.Approver8
          oPaperDataSet.InitiName = oData.InitiName
          oPaperDataSet.Appr1Name = oData.Appr1Name
          oPaperDataSet.Appr2Name = oData.Appr2Name
          oPaperDataSet.Appr3Name = oData.Appr3Name
          oPaperDataSet.Appr4Name = oData.Appr4Name
          oPaperDataSet.Appr5Name = oData.Appr5Name
          oPaperDataSet.Appr6Name = oData.Appr6Name
          oPaperDataSet.Appr7Name = oData.Appr7Name
          oPaperDataSet.Appr8Name = oData.Appr8Name*/
          ...
          $.each(oData.Nav_ItemsX, function (i, Row) {
            ...
            if (Row.VendorFlag == "") {
              ...
              Nav_Items[vIndexItem].LOIPrice = Row.LOIPrice;
              ...
              // Added by REDDRA-CONT on 07/05/2022   
...
//            vTitle = "Success";
//          }
//                    oPaperDataSet.Nav_Items = Nav_Items
//          oModelSSUDigitization.setProperty("/Validation", oData);
//          oModelSSUDigitization.setProperty("/PaperDataSet", oPaperDataSet);
//          oModelSSUDigitization.refresh();
//          Message.success(vMsg, {
//            title: vTitle
//          });
...
//        Remove end by AGAWSA-CONT SF1K92101
    ...
    var oMandatoryFlag = true;
        var existingDate = oFields[20]._lastValue;
        existingDate = new Date(existingDate.split(".").reverse().join("-"));
        var validFromDate = oFields[22]._lastValue;
        ...
        row.setValueStateText("this field is required");
         oMandatoryFlag = false;
          ...
          oFields[22].setValueState("Error");
          oFields[22].setValueStateText("Valid From Date is older than Existing Valid From date");
           oMandatoryFlag = false;
               }
...
//          if (RowDMS.TabId == "MAC"){
//            vFlagMAC = true;
//          }else if(RowDMS.TabId == "CT"){
//            vFlagCT = true;
//          }else if(RowDMS.TabId == "WT"){
//            vFlagWT = true;
//          }else if(RowDMS.TabId == "DIMS"){
//            vFlagDIMS = true;
//          }
//        });
//        if(vFlagMAC && vFlagCT && vFlagWT && vFlagDIMS)
//            vFlagTabId = true;
//        if (!vFlagTabId) {
//          vFlag = false;
//          oTabIconColor.VendorPartDetails = "Negative";
        ...
        oDataAmendmentModel.read("/ES_Vendor", {
          ...
          success: function (oData, oResponse) {
            ...
            if(vPinforcat == oData.results[0].Pinforcat || vPinforcat == ""){
              ...
              /*sap.m.MessageToast.show(vSelectedValue + " either does not exist or not extended for " + oParentModel.getProperty("/Plant")+ 
                  " plant or P-info record not found.");*/
            }
            ...
            oController.getLOIPrice(oParentModel);
          },
          error: function (oResponse) {
            serviceError(oResponse);
          }
...
//    Function for LOI Price
    getLOIPrice : function(oParentModel){
      var oController = this;
      var oModelSSUDigitization = oController.getView().getModel("ModelSSUDigitization");
      var oDataAmendmentModel = oController.getOwnerComponent().getModel("oDataAmendmentModel");
      var vPaperCode = oModelSSUDigitization.getProperty("/PaperDataSet/PaperCode");
      var vFilters = [];
      vFilters.push(new sap.ui.model.Filter("PaperCode", sap.ui.model.FilterOperator.EQ, vPaperCode));
      ...
      vFilters.push(new sap.ui.model.Filter("VendCode", sap.ui.model.FilterOperator.EQ, oParentModel.getProperty("/Vendor")));
      vFilters.push(new sap.ui.model.Filter("Pinforcat", sap.ui.model.FilterOperator.EQ, oParentModel.getProperty("/Pinforcat")));
      busyDialog.open();
      oDataAmendmentModel.read("/ES_LOIPrice", {
        filters: vFilters,
        success: function (oData, oResponse) {
            var vLOIPrice = oData.results[0].LOIPrice;
            oParentModel.setProperty("/LOIPrice", vLOIPrice);
            busyDialog.close();

        },
        error: function (oResponse) {
          busyDialog.close();
          Message.error("No combination found for Plant,Vendor and Part No in NPI", {
            title: "Error"
          });
        }
      });
...
//    editablePaperPur: function(vEditable, vNav_Items, vNotCreateNew){
...
//    Date formatter
    ...
    editablePaperpur: function(vEditable, oNavItem){
      return vEditable && !oNavItem ? true:false;
    },
...
//  Added by AGAWSA-CONT SF1K92101
    visiblePartEdit: function(vEditable, vSector, vModel, vPurpose, vSelfRouting, vInitiatedBySSU){
      var oController = this;
      var vCurrentUser = sap.ushell.Container.getService("UserInfo").getId();
      var oModelSSUDigitization = oController.getView().getModel("ModelSSUDigitization");
...
//    Formatter for Settle price based on Valid From dte 
...
//        oModelSSUDigitization.setProperty("/PaperDataSet/Initiator", "");
    ...
    onAddForexItem: function () {
      var oController = this;
      var oItemFrag = xmlFragment(oController, "ItemActlstn");
      var oModel = new JSONModel(getItemDetailsObjectPA());
...
//                    title: vMsgReturn.Title,
    ...
    onExport: function () {
      ...
      var oSettings = {
        workbook: {
          columns: getExportExcelColumsPA(),
