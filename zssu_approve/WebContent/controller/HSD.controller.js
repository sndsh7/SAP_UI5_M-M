sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.HSD", {
		onInit: function () {
			// Fiori Usage
			var device = "Other";
			var os = jQuery.os.os;
...
//			oController._onObjectMatched(["new","HSD"]);
			...
			oRouter.getRoute("HSD").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		_onObjectMatched: function (oEvent) {
			...
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/HSD.json');
...
//					oItemData.Amndcode = row.Price_Change_Code || "";
		...
		_validationMass: function (Nav_Items) {
			...
			oController.getOwnerComponent().getModel("oDataAmendmentModel").create("/ES_HeaderX", oValidation, {
				success: function (oData, oResponse) {
					var vMsg = "There are some issues in this price paper, please check.";
...
//							sap.m.MessageToast.show(vSelectedValue + " either does not exist or not extended for " + oParentModel.getProperty("/Plant") + " plant.");
		...
		visiblePartEdit: function(vEditable, vSector, vModel,vPlant, vInitiatedBySSU) {
