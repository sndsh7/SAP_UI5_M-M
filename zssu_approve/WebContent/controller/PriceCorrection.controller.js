sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.PriceCorrection", {
		onInit: function () {			
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("PC").attachPatternMatched(this._onObjectMatched, this);
		}, 
		...
		_onObjectMatched: function (oEvent) {
			...
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/PriceCrctn.json');
		...
		/*_validationDataFilled: function () {
			...
			$.each(oPaperData.Nav_Items, function (i, Row) {
				...
				if (Row.Plant == "" || Row.Vendor == "" || Row.PartNo == "" || Math.abs(Row.SettledPrice) == "" || Math.abs(Row.SettledPrice) == "0"
					|| Row.Amndcode == "" || Row.ValidFrom == null || Row.LastAmmndDate == null || Row.Pinforcat == "" || Row.Purorg == "" || Row.Sign == "" ||
