sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.Rocm", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("RCM").attachPatternMatched(this._onObjectMatched, this);
		}, 
		...
		_onObjectMatched: function (oEvent) {
			...
			var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/Rocm.json');
		...
		_fnMassDataSet: function (vExcelDataArray) {
			...
			$.each(vExcelDataArray, function (MainIndex, row) {
				...
				if (oFilter.length <= 0) {
					...
					oItemData.LOIPrice = row.LOI_Price || "0";
