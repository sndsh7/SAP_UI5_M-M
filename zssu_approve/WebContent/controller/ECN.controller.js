sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("com.mahindra.ZSSU_Approve.controller.ECN", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
//			oRouter.attachRoutePatternMatched(this._onObjectMatched, this);
			oRouter.getRoute("ECN").attachPatternMatched(this._onObjectMatched, this);
		},
		//--------- Local Methods Start -------------------------
		_onObjectMatched: function (oEvent) {
			...
			/*if(vPaperCode == "ECN")
				var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_Approve', '/json/ECN.json');
			else if (vPaperCode == "PC")
		...
		_fnMassDataSet: function (vExcelDataArray) {
			...
			$.each(vExcelDataArray, function (MainIndex, row) {
				...
				if (oFilter.length <= 0) {
					...
					oItemData.SanctiondBudget = row.Sanctioned_Budget || "0";
					oItemData.QtyPerVeh = row.Qty_per_vehicle || "0";
					oItemData.QuotedPrice = row.Quoted_Price || "0";
