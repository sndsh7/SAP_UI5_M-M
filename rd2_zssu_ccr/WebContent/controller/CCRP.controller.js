sap.ui.define(["sap/ui/core/mvc/Controller",
  ...
  "use strict";
  return Controller.extend("com.mahindra.ZSSU_CCR.controller.CCRP", {
    onInit: function () {
      // Fiori Usage
      var device = "Other";
      var os = jQuery.os.os;
      ...
      oDataModel.read("/FioriUsageSet(Appname='ZSSU_CCR',Device='" + device +
...
//      oController._onObjectMatched(["new","CCR"]);
    },
    ...
    _onObjectMatched: function (oParameter) {
      ...
      var sUrl = jQuery.sap.getModulePath('com.mahindra.ZSSU_CCR', '/json/ECN.json');
      ...
      if (vPaperNo == "new") {
        ...
        oModel.setProperty("/SSURequest", false);	// Added by beena 50002903 on 03-03-2023
        var oData = getHeaderObjectCCR();
        oData.PaperCode= vPaperCode;
        oData.Createdby = vCurrentUser; // added by AGAWSA-CONT 
...
//    Added by AGAWSA-CONT-SF1K920444
      ...
      //added by beena 50002903 on 03-03-2023  for delegate to associate entity read
      var filters = [new sap.ui.model.Filter("PaperCode", sap.ui.model.FilterOperator.EQ, vPaperCode)];
      ...
      //End by beena 50002903 on 03-03-2023  for delegate to associate entity read
    ...
    _fnAfterGettingBEData: function (oData) {
      ...
      com.mahindra.ZSSU_CCR.oData = oData;//added by beena on 13-03-2023
      var vCurrentUser = sap.ushell.Container.getService("UserInfo").getId(); // Added by beena 50002903 on 03-03-2023
...
//        }
      ...
      Row.DeltaPrice = Number(Row.SettledPrice) - Number(Row.ExtPrice);
...
//commented by beena 50002903 on 03-03-2023
      ...
      if(oData.Status === "IC" && oModelSSUDigitization.getProperty("/PartSettlementTracker") != "X")
        oModelSSUDigitization.setProperty("/PostToSAP", true);
      if(oData.Status === "NR" && oModelSSUDigitization.getProperty("/PartSettlementTracker") != "X")
        oModelSSUDigitization.setProperty("/NonSSURequest", true);
*/
    //commented by beena 50002903 on 03-03-2023
      
      
      //added by beena 50002903 on 03-03-2023
...
//                oModelSSUDigitization.setProperty("/EditableFlag", false);
          ...
          if(oData.Nav_Wf.length === 0 && oData.Status !== "NR"){
            ...
            this.getView().byId("redelegation").setVisible(false);
          }else if(oData.Nav_Wf.length !== 0 && (oData.Status === "C" || oData.Status === "R")){
            this.getView().byId("redelegation").setVisible(false);
          }else{
        ...
        this.getView().byId("id_upc6").setEnableDelete(false);
      ...
      //End by beena 50002903 on 03-03-2023
...
//         oController.getView().byId("id_status").getNumber() === "Request" || 
      ...
      if(oData.Initiator == vCurrentUser && oData.AssociateFlag === "X"){
        if(oData.AssociatePrev == oData.Associate && oData.Nav_Wf.length !== 0){
          if(oController.getView().byId("id_status").getNumber() === "Pending" || 
                ...
                this.getView().byId("redelegation").setVisible(false);
                this.getView().byId("id_InputAssociate").setEditable(true);// ADD AGAWSA-CONT-SF1K920444
              }
                ...
                this.getView().byId("id_InputAssociate").setEditable(true);// ADD AGAWSA-CONT-SF1K920444
                  ...
                  this.getView().byId("redelegation").setVisible(false);
                this.getView().byId("id_InputAssociate").setEditable(false);// ADD AGAWSA-CONT-SF1K920444
                }
      ...
      var oActionItem = new sap.m.HBox({
        ...
        items: [
          ...
          new sap.m.Button({
            ...
            press: function (oEvent) {
//              Add Start by AGAWAS-CONT on 13-03-2023
...
//                Add End by AGAWAS-CONT on 13-03-2023 
...
//                contentWidth: "30%",
  ...
  _fnMassDataSet: function (vExcelDataArray) {
      ...
      $.each(vExcelDataArray, function (MainIndex, row) {
        ...
        if (oFilter.length <= 0) {
          var oItemData = getItemDetailsObjectCCR();
...
//        }
    ...
    onExport: function () {
      ...
      var oSettings = {
        workbook: {
          columns: getExportExcelColumsCCR(),
...
//          ADD Start by beena 50002903 on 03-03-2023 error data sort to top
...
//         End by beena 50002903 on 03-03-2023
    ...
    _getModelPlant: function (vSelectedSectors) {
      ...
      _fnRequredFieldCheck: function (oFields) {
        ...
        var existingDate = oFields[38]._lastValue;
        existingDate = new Date(existingDate.split(".").reverse().join("-"));
        var validFromDate = oFields[36]._lastValue;
      ...
      oFields[36].setValueState("Error");
      oFields[36].setValueStateText("Valid From Date is older than Existing Valid From date");
      oMandatoryFlag = false;
        }
...
//    Removed by AGAWSA-CONT-SF1K920444
//    ADD Start by beena 50002903 on 03-03-2023
...
//        }
//      }
//    ADD End by beena 50002903 on 03-03-2023
    //commented by beena 50002903 on 03-03-2023
     /* if (oPaperData.Nav_Items.length <= 0) {
        oTabIconColor.VendorPartDetails = "Negative";
      }*/
...
//        new sap.ui.model.Filter("Sign", sap.ui.model.FilterOperator.EQ, oPaperData.Sign),
        ...
        new sap.ui.model.Filter("AssociateFlag", sap.ui.model.FilterOperator.EQ, oPaperData.AssociateFlag), // Added by beena 50002903 on 03-03-2023 associate flag for get workflow
        new sap.ui.model.Filter("Initiator", sap.ui.model.FilterOperator.EQ, oPaperData.Initiator)      // Added by beena 50002903 on 03-03-2023 associate flag for get workflow
...
//    Insert start by AGAWSA-CONT on 28.08.2023
    visiblePaperPurpose: function(vPaperPurpose){
      if(vPaperPurpose == "00"){
        return false;
      }else{
        return true;
...
//  Insert end by AGAWSA-CONT on 28.08.2023
//  visible attachments
//  added start by REDDRA-CONT on 18-01-2022
//    Added by AGAWSA-CONT-SF1K920444
...
//  Added end by AGAWSA-CONT-SF1K920444
...
//  ADD Start By AGAWSA-CONT-SF1K920444
...
//  Remove by AGAWSA-CONT-SF1K920444
//    visiblePartEdit: function(vEditable, vSector, vModel,  vAssociate, vAssociateEdit) {
...
//        oModelSSUDigitization.setProperty("/PaperDataSet/Initiator", "");
    ...
    onAddForexItem: function () {
      var oController = this;
//    Add Start by by beena 50002903 on 03-03-2023
      var vInitiator = oController.getView().getModel("ModelSSUDigitization").getProperty("/PaperDataSet/Initiator");
      var vCurrentUser = sap.ushell.Container.getService("UserInfo").getId();
      if(oController.getView().getModel("ModelSSUDigitization").getProperty("/PaperDataSet/AssociateFlag") == "X"){
        if(vInitiator == vCurrentUser){
...
//      Add End by by beena 50002903 on 03-03-2023
      var oItemFrag = xmlFragment(oController, "ItemCCR");
...
//    Added Start by beena 50002903 on 03-03-2023
//      if(oModelSSUDigitization.getProperty("/PaperDataSet/AssociateFlag") == "X"){
//        if(this.getView().byId("id_InputAssociate").getValue() == ""){
//          Message.error("Select Associate before saving the paper", {
//            title: "Information"
//          });
//          return;  
//        }
...
//    Added End by  beena 50002903 on 03-03-2023
...
//        var vButtonType = oEvent.getSource().getProperty("type");
    ...
    //End by bbeena 50002903 on 03-03-2023
...
//      var vErrFlag = oModelSSUDigitization.oData.Validation.ErrorFlag; 
//      if(vErrFlag == "X"){
//        Message.error("Please Clear Error item before Submit", {
//              title: "Error"
//            });
//        return;
//      }
//    Add Start by AGAWSA-CONT on 27-01-2023
...
//      var vButtonType = oEvent.getSource().getProperty("type");
    ...
    _fnLockUnlockService:function(vLock) {
      ...
      var vAssociateFlag = oModelSSUDigitization.getProperty("/PaperDataSet/AssociateFlag"); // Added by beena 50002903 on 03-03-2023
      var vAssociate = oModelSSUDigitization.getProperty("/PaperDataSet/Associate"); // Added by beena 50002903 on 03-03-2023
      var vInitiator = oModelSSUDigitization.getProperty("/PaperDataSet/Initiator"); // Added by beena 50002903 on 03-03-2023
      var vCurrentUser = sap.ushell.Container.getService("UserInfo").getId(); // Added by beena 50002903 on 03-03-2023
